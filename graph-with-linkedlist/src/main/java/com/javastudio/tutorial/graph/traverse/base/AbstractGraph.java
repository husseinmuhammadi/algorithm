package com.javastudio.tutorial.graph.traverse.base;

import com.javastudio.tutorial.graph.traverse.exceptions.VertexNotFoundException;

import java.util.*;

public abstract class AbstractGraph/*<T extends Node<T>>*/ {
    ...
    protected Node findNode(Node node) throws VertexNotFoundException {
